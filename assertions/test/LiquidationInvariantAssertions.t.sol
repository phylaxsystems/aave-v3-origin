...
contract TestLiquidationInvariantAssertions is CredibleTest, Test, TestnetProcedures {
    ...
    function test_assertionHealthFactorThreshold() public {
        ...
        cl.validate(
            ...
            abi.encodeWithSelector(
                pool.liquidationCall.selector, testCollateralAsset, testDebtAsset, testUser, 100e8, false
            )
        );
        vm.stopPrank();
    }
    ...
    function test_assertionGracePeriod() public {
        ...
        WorkingProtocol(address(pool)).setLiquidationGracePeriod(testCollateralAsset, uint40(block.timestamp));
