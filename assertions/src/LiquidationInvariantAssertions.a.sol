...
contract LiquidationInvariantAssertions is Assertion {
    ...
    function assertLiquidationAmounts() external {
        ...
        for (uint256 i = 0; i < callInputs.length; i++) {
            ...
            bool minimumLeftover =
                postDebtBalance >= pool.MIN_LEFTOVER_BASE() && postCollateralBalance >= pool.MIN_LEFTOVER_BASE();
    ...
    function assertDeficitAccounting() external {
        ...
        for (uint256 i = 0; i < callInputs.length; i++) {
            ...
            if (postDeficit > preDeficit) {
                ...
                require(postDeficit - preDeficit == preUserDebt - postUserDebt, "Deficit accounting mismatch");
            }
        }
    }
    ...
    function assertActiveReserveDeficit() external {
        ...
        for (uint256 i = 0; i < callInputs.length; i++) {
            ...
            require(ReserveConfiguration.getActive(collateralReserve.configuration), "Collateral reserve not active");
